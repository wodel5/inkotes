...
abstract class SentryFilter {
  ...
  /// https://foledge-yf.sentry.io/settings/security-and-privacy/
  /// so users on older versions of foledge still get their data scrubbed.
  @visibleForTesting
  static final replacements = <Pattern, String>{
    // foledgeSyncFile(...)
    RegExp(r'foledgeSyncFile\(.+\)'): 'foledgeSyncFile([redacted])',
    // Remote file paths
