...
import 'package:foledge/data/version.dart';
...
class AppInfo extends StatelessWidget {
  ...
  static final Uri privacyPolicyUrl = Uri.parse(
    'https://foledge.adil.hanney.org/privacy-policy/',
  );
  static final Uri licenseUrl = Uri.parse(
    'https://github.com/foledge-notes/foledge/blob/main/LICENSE.md',
  );
  static final Uri releasesUrl = Uri.parse(
    'https://github.com/foledge-notes/foledge/releases',
  );
